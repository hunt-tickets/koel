...
function ValueItem({ icon, title, description, delay }: ValueItemProps) {
  return (
    ...
    >
      <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-koel-blue to-koel-bamboo rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
        {icon}
      </div>
      <div>
        <h4 className="text-lg font-bold text-koel-neutral-900 mb-1">
          {title}
        </h4>
        <p className="text-koel-neutral-600 leading-relaxed">
          {description}
        </p>
      </div>
    </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-premium-lg">
              {/* Video Placeholder */}
              <div className="aspect-[9/16] bg-gradient-to-br from-koel-neutral-200 to-koel-neutral-300 flex items-center justify-center">
                <div className="text-center px-8">
                  <p className="text-koel-neutral-600 mb-4">
                    [Placeholder para video premium]
                  </p>
                  <p className="text-sm text-koel-neutral-500">
              ...
              {/* Video Overlay Text */}
              <div className="absolute bottom-0 left-0 right-0 glass-dark p-8 text-center">
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-koel-blue to-koel-bamboo rounded-full opacity-20 blur-2xl"
            />
            <motion.div
              animate={{
                y: [0, 10, 0],
              ...
              className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-to-br from-koel-ginger to-koel-bamboo rounded-full opacity-20 blur-2xl"
            />
          </motion.div>
        </div>
      </div>
